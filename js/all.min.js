...
BasicGame.Boot.prototype = {
  ...
  preload: function () {
    ...
    this.load.image('preloaderBackground', 'Kyra/assets/img/title.png');
...
BasicGame.Preloader.prototype = {
	...
	preload: function () {
		...
		this.load.atlasJSONArray('player', 'Kyra/assets/sprites/brandon.png', 'Kyra/assets/sprites/brandon.json');
		this.load.atlasJSONArray('fairy', 'Kyra/assets/sprites/fairy.png', 'Kyra/assets/sprites/fairy.json');

		this.load.image('titlepage', 'Kyra/assets/img/title.png');
		this.load.image('gui', 'Kyra/assets/img/gui.png');
		this.load.image('pathing', 'Kyra/assets/tiles/pathing.png');
		
		this.load.json('rooms', 'Kyra/js/json/rooms.json');
		this.load.json('music', 'Kyra/js/json/music.json');
		this.load.json('sprites', 'Kyra/js/json/sprites.json');
		
		this.load.spritesheet('items', 'Kyra/assets/img/item_sheet.png', 32, 32);
